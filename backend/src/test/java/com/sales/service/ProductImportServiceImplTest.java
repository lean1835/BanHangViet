...
import com.sales.repository.ProductGroupRepository;
import com.sales.repository.ProductRepository;
import com.sales.repository.TaxRateRepository;
import com.sales.repository.UserRepository;
import com.sales.service.classes.ProductImportServiceImpl;
...
class ProductImportServiceImplTest {
    ...
    void importProducts_PercentageFormattedTaxRate_Success() throws Exception {
        com.sales.entity.TaxRate sampleTax8Percent = com.sales.entity.TaxRate.builder()
                .id("tax-008")
                .name("Thuế 8%")
    ...
    void importProducts_ExplicitPercentSymbolUnderOnePercent_Success() throws Exception {
        com.sales.entity.TaxRate sampleTaxHalfPercent = com.sales.entity.TaxRate.builder()
                .id("tax-005")
                .name("Thuế 0.5%")
    ...
    void importProducts_TaxRateVietnameseComma_Success() throws Exception {
        com.sales.entity.TaxRate sampleTax8Point5 = com.sales.entity.TaxRate.builder()
                .id("tax-085")
                .name("Thuế 8.5%")
