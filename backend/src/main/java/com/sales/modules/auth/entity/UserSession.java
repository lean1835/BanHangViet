...
@Table(name = "user_sessions", indexes = {
    ...
    @Index(name = "idx_user_sessions_household_id", columnList = "household_id"),
    @Index(name = "idx_user_sessions_active", columnList = "household_id, is_revoked, last_active_at")
})
@Getter
@Setter
@Builder
