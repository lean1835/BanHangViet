...
import com.sales.modules.report.dto.response.MonthlyRevenueBreakdownResponse;
import com.sales.modules.tax.dto.response.AnnualRevenueTrackingResponse;
import com.sales.common.constant.RevenueThresholdConstants;
import com.sales.common.constant.RevenueWarningStatus;
...
public class AnnualRevenueTrackingServiceImpl implements AnnualRevenueTrackingService {
    ...
    static {
        VIETNAM_SYMBOLS = new DecimalFormatSymbols(Locale.forLanguageTag("vi-VN"));
    ...
    public AnnualRevenueTrackingResponse getAnnualRevenueTracking(String currentUsername, Integer year) {
        ...
        for (int m = 1; m <= 12; m++) {
            monthlyBuckets.put(m, new MonthAccumulator());
        }
