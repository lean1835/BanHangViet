...
import com.sales.modules.report.dto.response.PeakDayOfWeekProjection;
import com.sales.modules.report.dto.response.PeakHeatmapProjection;
import com.sales.modules.report.dto.response.PeakHourlyProjection;
import com.sales.modules.pos.dto.response.PosDailyRevenueProjection;
...
import com.sales.modules.product.dto.response.ProductSalesSummaryProjection;
import com.sales.modules.inventory.dto.response.PurchaseSuggestionProjection;
import com.sales.modules.pos.dto.response.ShiftSalesMetricsProjection;
import com.sales.modules.product.dto.response.SlowMovingProductProjection;
import com.sales.modules.product.dto.response.SlowMovingSummaryProjection;
...
public interface OrderRepository extends JpaRepository<Order, String> {
    ...
    @Query("SELECT o FROM Order o LEFT JOIN FETCH o.createdByUser " +
           ...
           "AND (o.paymentStatus IN ('PAID', 'DEBT', 'UNPAID') OR o.paymentMethod = 'DEBT') " +
