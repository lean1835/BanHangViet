...
public class ProductController {
    ...
    @PostMapping("/import")
    @PreAuthorize("hasRole('VT-01')")
    public ResponseEntity<ApiResponse<com.sales.dto.response.ImportProductResultResponse>> importProducts(
            Principal principal,
            @RequestParam("file") MultipartFile file) {
        com.sales.dto.response.ImportProductResultResponse result = productImportService.importProducts(principal.getName(), file);
        ApiResponse<com.sales.dto.response.ImportProductResultResponse> response = ApiResponse.<com.sales.dto.response.ImportProductResultResponse>builder()
                .code(1000)
