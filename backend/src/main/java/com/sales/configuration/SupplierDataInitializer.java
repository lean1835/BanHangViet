    ...
    public void run(String... args) throws Exception {
        ...
        List<Supplier> mockSuppliers = Arrays.asList(
                Supplier.builder()
                        ...
                        .note("Nhà cung cấp dược mỹ phẩm")
                ...
                Supplier.builder()
                        ...
                        .note("Đại lý phân phối nước giải khát")
                        .currentDebt(BigDecimal.ZERO)
                        .totalPurchase(BigDecimal.ZERO)
                        .status("ACTIVE")
                        .build(),
                ...
                Supplier.builder()
                        ...
                        .note("Gia dụng và thiết bị cửa hàng")
                        .currentDebt(BigDecimal.ZERO)
                        .totalPurchase(BigDecimal.ZERO)
                        .status("ACTIVE")
                        .build(),
                ...
                Supplier.builder()
                        ...
                        .note("Đối tác phần mềm KiotViet & phần cứng POS")
                        .currentDebt(BigDecimal.ZERO)
                        .totalPurchase(BigDecimal.ZERO)
                        .status("ACTIVE")
                        .build(),
                ...
                Supplier.builder()
                        ...
                        .note("Thực phẩm đóng gói Hoàng Gia")
                        .currentDebt(BigDecimal.ZERO)
                        .totalPurchase(BigDecimal.ZERO)
                        .status("ACTIVE")
                        .build(),
                ...
                Supplier.builder()
                        ...
                        .note("Giao hàng mỗi sáng thứ 2, 4, 6. Chiết khấu 2% cho đơn > 10 triệu.")
                ...
                Supplier.builder()
                        ...
                        .note("Nhà cung cấp hóa chất & hóa mỹ phẩm uy tín.")
                ...
                Supplier.builder()
                        ...
                        .note("Chuyên hải sản khô, tôm khô, mực khô.")
