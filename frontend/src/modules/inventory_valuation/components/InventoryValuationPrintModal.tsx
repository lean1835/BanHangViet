    ...
    >
      <style>{`
        @media print {
          ...
          body > *:not(#inventory-valuation-print-modal-portal) {
            display: none !important;
          }
          #inventory-valuation-print-modal-portal {
          ...
          #inventory-valuation-print-panel {
            position: static !important;
            display: block !important;
            width: 100% !important;
          ...
          #inventory-valuation-print-scroll-container {
            position: static !important;
            display: block !important;
            width: 100% !important;
            margin: 0 !important;
          ...
          #printable-inventory-valuation table {
            width: 100% !important;
            border-collapse: collapse !important;
            border: 1px solid #000000 !important;
            page-break-inside: auto !important;
          }
          #printable-inventory-valuation tr {
            page-break-inside: avoid !important;
            page-break-after: auto !important;
          }
          #printable-inventory-valuation th {
            border: 1px solid #000000 !important;
            color: #000000 !important;
          ...
          #printable-inventory-valuation td {
            border: 1px solid #000000 !important;
            color: #000000 !important;
