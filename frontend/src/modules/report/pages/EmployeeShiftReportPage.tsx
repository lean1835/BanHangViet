...
import { EmployeeShiftReport } from "../components/EmployeeShiftReport";
    ...
    return (
      <div className="p-8 max-w-lg mx-auto text-center space-y-4 animate-fade-in my-12 bg-white rounded-2xl border border-rose-200 shadow-xs">
        ...
        <p className="text-xs text-slate-500 leading-relaxed">
          Tài khoản của bạn với vai trò <strong>Thu ngân (VT-02)</strong> không có quyền xem báo cáo kiểm soát ca và hiệu suất toàn bộ nhân viên. Vui lòng liên hệ Chủ hộ (VT-01) hoặc Kế toán (VT-03) để được phân quyền.
        </p>
      </div>
    );
  }
