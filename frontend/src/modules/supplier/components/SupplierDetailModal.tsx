...
export const SupplierDetailModal: React.FC<SupplierDetailModalProps> = ({
  ...
  return createPortal(
    ...
    >
      <div
        className="app-modal-panel flex flex-col w-full max-w-2xl bg-white rounded-2xl shadow-2xl overflow-hidden animate-modal-bounce-in"
              ...
              >
                ...
                {canManage && hasDebt && (
                  <button
                    ...
                    className="flex items-center gap-1 px-3.5 py-2 rounded-lg bg-rose-600 hover:bg-rose-700 active:scale-95 text-white text-xs font-bold shadow-sm transition-all"
                  >
                    Thanh toán ngay
                  </button>
                )}
          ...
          <div className="flex items-center gap-2.5">
            {canManage && hasDebt && (
              <button
                type="button"
                onClick={handleTriggerPay}
                className="flex items-center gap-1.5 px-4 py-2 rounded-lg bg-emerald-600 hover:bg-emerald-700 active:scale-95 text-xs font-bold text-white shadow-sm transition-all"
              >
                <Wallet size={14} />
                Thanh toán nợ
              </button>
