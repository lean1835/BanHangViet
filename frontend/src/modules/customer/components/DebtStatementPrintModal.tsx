    ...
    >
      <style>{`
        @media print {
          ...
          /* Ẩn hoàn toàn ứng dụng nền #root để loại bỏ trang trắng */
          #root {
          ...
          body > *:not(#debt-statement-modal-portal) {
            display: none !important;
          }
          /* Unwrap toàn bộ các container cha để văn bản in xuất phát ngay từ đầu trang */
          #debt-statement-modal-portal {
          ...
          #debt-statement-scroll-container {
            position: static !important;
            display: block !important;
            width: 100% !important;
            margin: 0 !important;
          ...
          #printable-debt-statement #debt-statement-parties-grid {
          ...
          #printable-debt-statement #debt-statement-parties-grid > div {
            flex: 1 1 0% !important;
            width: 50% !important;
          }
          #printable-debt-statement table {
            width: 100% !important;
          ...
          #printable-debt-statement thead {
            display: table-header-group !important;
          }
          #printable-debt-statement tbody {
            display: table-row-group !important;
          }
          #printable-debt-statement tfoot {
            display: table-footer-group !important;
          }
          #printable-debt-statement tr {
            page-break-inside: avoid !important;
            break-inside: avoid !important;
            page-break-after: auto !important;
          }
          #printable-debt-statement th {
            border: 1px solid #000000 !important;
            color: #000000 !important;
          ...
          #printable-debt-statement td {
            border: 1px solid #000000 !important;
            color: #000000 !important;
            padding: 4px 6px !important;
            font-size: 10pt !important;
          }
          #printable-debt-statement .overflow-x-auto {
            overflow: visible !important;
            display: block !important;
          }
          #printable-debt-statement .section-title {
            page-break-after: avoid !important;
            break-after: avoid !important;
          }
          #printable-debt-statement #debt-statement-conclusion {
            page-break-inside: avoid !important;
            break-inside: avoid !important;
          }
          #printable-debt-statement #debt-statement-footer {
            page-break-inside: avoid !important;
            break-inside: avoid !important;
          }
          #printable-debt-statement #debt-statement-signatures {
            display: flex !important;
            flex-direction: row !important;
            justify-content: space-between !important;
            gap: 20px !important;
          ...
          #printable-debt-statement #debt-statement-signatures > div {
            flex: 1 1 0% !important;
            width: 50% !important;
          }
          #printable-debt-statement .signature-space {
