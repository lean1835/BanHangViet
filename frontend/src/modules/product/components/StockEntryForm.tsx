...
export const StockEntryForm = ({ currentRole, products, onSubmit }: StockEntryFormProps) => {
  const [importPriceDisplay, setImportPriceDisplay] = useState<string>("");
            ...
            <div className="flex flex-col gap-1">
              ...
              <input
                ...
                onChange={(e) => {
                  ...
                  setImportPriceDisplay(rawVal ? formatNumber(Number(rawVal)) : "");
                }}
                required
              ...
              <input
                ...
                value={importPriceDisplay ? importPriceDisplay.replace(/\D/g, "") : "0"}
              />
            </div>
          </div>
